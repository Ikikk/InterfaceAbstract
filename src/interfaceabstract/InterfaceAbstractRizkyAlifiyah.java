 ...
 * @author ASUS
 */
public class InterfaceAbstractRizkyAlifiyah {
    /**
     * @param args the command line arguments
     */
    public static void main(String[] args) {
        Account acc1 = new Account("Rizky Alifiyah Rahma", "12345", 1000);
//        System.out.println(acc1.getBankName());
        acc1.deposit(1000);
        acc1.deposit(1000);
        acc1.print();
        
        CreditAccount acc2 = new CreditAccount("Gojo Satoru", "54545", 1000);
//        System.out.println(acc1.getBankName());
        acc2.print();
